...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "support_system")
        self.VERSION = os.getenv("VERSION", "1.0.0")
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "support_system"
        )
        ...
        self.LLM_BASE_URL = os.getenv("LLM_BASE_URL", "")  # Custom base URL for non-OpenAI models
